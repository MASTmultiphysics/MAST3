...
inline void test_heaviside_sensitivity()  {

    
    Context c;
    DensityField<real_t> field;
    MAST::Optimization::Topology::SIMP::HeavisideFilter
    <real_t, DensityField<real_t>>
    density;

    density.set_field(field);
    density.set_parameters(10., 0.2);
    ...
    // complex step sensitivity
    {
        ...
        density_cs.set_field(field_cs);
        density_cs.set_parameters(10., 0.2);
    ...
    // automatic differentiation
    {
        ...
        density_ad.set_field(field_ad);
        density_ad.set_parameters(10., 0.2);
...
TEST_CASE("heaviside_filter_sensitivity",
          "[Optimization][Topology][SIMP][ComplexStep][AdolC]") {
    
    test_heaviside_sensitivity();
}
