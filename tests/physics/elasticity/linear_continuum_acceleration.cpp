...
namespace LinearAccelerationKernel {
...
struct Traits {
    ...
    using density_f_t       = typename MAST::Test::Physics::Elasticity::LinearContinuum::LinearAccelerationKernel::ScalarField<density_t>;
    using th_f_t            = typename  MAST::Test::Physics::Elasticity::LinearContinuum::LinearAccelerationKernel::ScalarField<th_t>;
    using acc_t             = typename MAST::Physics::Elasticity::LinearContinuum::LinearAcceleration<fe_var_t, density_f_t, th_f_t, Dim, Context>;
};
...
struct ElemOps {
    ...
    acc_e    (new typename Traits::acc_t) {
        ...
        acc_e->set_section_area(*th_f);
        acc_e->set_density(*rho_f);
...
TEST_CASE("linear_continuum_acceleration",
          "[2D][QUAD4][Elasticity][Linear][Acceleration]") {
