...
#ifndef __mast_libmesh_fe_data_h__
#define __mast_libmesh_fe_data_h__
...
public:
    ...
    using quadrature_t       = typename MAST::Quadrature::libMeshWrapper::Quadrature<real_t, Dim>;
...
#endif // __mast_libmesh_fe_data_h__
