...
#ifndef __mast_libmesh_material_point_output_derivative_h__
#define __mast_libmesh_material_point_output_derivative_h__
...
class MaterialPointOutputDerivative {
...
public:
    ...
    inline void assemble(ContextType            &c,
        ...
        for ( ; el != end_el; ++el) {
            ...
            _e_ops->derivativeX(c, sol_accessor, index, stress, dqdX_e);
...
#endif // __mast_libmesh_material_point_output_derivative_h__
